...
export default function PlaceGallery({ place }) {
  ...
  // showing photos when we press show more photos
        ...
        <div className=" bg-black p-8 grid gap-4">
          <div>
            ...
            <button
              ...
              className=" fixed right-8 top-8 flex gap-1 py-2 px-2 rounded-2xl shadow shadow-black bg-white text-black"
            >
              <svg
    ...
    <div className="relative">
      <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
        ...
        <div className=" grid">
          ...
          {/* logic we used for setting the height and trimming
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className=" flex gap-1 absolute bottom-1 right-1 py-1 px-0 bg-gray-100 rounded-xl shadow-md shadow-gray-500 "
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
